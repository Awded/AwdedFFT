...
namespace Visualization
{
    public class SpectrumBase : INotifyPropertyChanged
    {
        ...
        public List<SpectrumPointData> GetData(double maxValue, float[] fftBuffer) {
        ...
        protected virtual List<SpectrumPointData> CalculateSpectrumPoints(double maxValue, float[] fftBuffer)
        {
